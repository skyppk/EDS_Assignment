 ...
 * @author apple
 */
@WebServlet(name = "EditGiftDetail", urlPatterns = {"/editGiftDetail"})
public class EditGiftDetail extends HttpServlet {
private GiftDB db;
   @Override
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("cancel".equalsIgnoreCase(action)) {
            ...
            double needPoint = Double.parseDouble(request.getParameter("needPoint"));
            String img = request.getParameter("img");
            
//            System.out.println("update user id :" + id);
//            System.out.println("update user status :" + status);
            db.editGiftInfo(giftId, giftName, desc, needPoint,img);
                response.sendRedirect("redeem?action=manage");
