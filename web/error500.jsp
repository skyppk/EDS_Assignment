<%-- 
    Document   : error500
    Created on : 2016/11/27, 上午 03:34:15
    Author     : apple
--%>
...
<html>
    <head>
        ...
        <script>
            $(function () {
                jspErrMsg = "You have not permission to view this page !";
                attrMsg = "You have not permission to view this page !";
                errMsg = "You have not permission to view this page !";
